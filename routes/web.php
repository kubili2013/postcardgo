...
Route::group(['prefix' => 'admin', 'as' => 'admin', 'namespace' => 'Admin'], function () {
    ...
    Route::get('/postcards', 'PostcardController@index')->name('.postcards');
    Route::get('postcard/{postcard}', 'PostcardController@show')->where('postcard','[0-9]+')->name('.postcard.show');
    Route::get('postcard/create', 'PostcardController@create')->name('.postcard.create');
    Route::post('postcard/create', 'PostcardController@store')->name('.postcard.store');
